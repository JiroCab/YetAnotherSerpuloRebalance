...
spiroctTorpedo.controllable = false;
spiroctTorpedo.autoTarget = true;
spiroctTorpedo.aiControllable = false;
spiroctTorpedo.useAttackRange = false;
spiroctTorpedo.layerOffset = -1;
spiroctTorpedo.shootCone = 360;
spiroctTorpedo.top = false;
spiroctTorpedo.mirror = false;
spiroctTorpedo.targetInterval = 20;
spiroctTorpedo.targetSwitchInterval = 35;
spiroctTorpedo.x = 0;
spiroctTorpedo.y = 0;
...
spiroctTorpedo.bullet.shrinkY = 0;
spiroctTorpedo.inaccuracy = 2;
spiroctTorpedo.bullet.weaveMag = 2;
spiroctTorpedo.bullet.weaveScale = 1.5;
spiroctTorpedo.bullet.speed = 2;
spiroctTorpedo.bullet.drag = -0.017;
spiroctTorpedo.bullet.homingPower = 0.085;
spiroctTorpedo.bullet.homingRange = 300;
spiroctTorpedo.bullet.collideFloor = true;
spiroctTorpedo.bullet.trailColor = Pal.sapBullet;
spiroctTorpedo.bullet.trailWidth = 2;
spiroctTorpedo.bullet.trailLength = 6;
...
UnitTypes.eclipse.health = 100000;
...
if(Version.number != 7){
	UnitTypes.retusa.weapons.get(1).y = 4;
	UnitTypes.retusa.weapons.get(1).x = -3;
	UnitTypes.retusa.weapons.get(2).y = 4;
...
if(Version.number != 7)Blocks.foreshadow.ammoTypes.get(Items.surgeAlloy).maxDamageFraction = -1;
