...
UnitTypes.spiroct.weapons.get(0).bullet.buildingDamageMultiplier = 0.01;
...
UnitTypes.spiroct.weapons.get(1).bullet.buildingDamageMultiplier = 0.01;
...
UnitTypes.arkyid.weapons.get(0).bullet.buildingDamageMultiplier = 0.01;
...
UnitTypes.arkyid.weapons.get(1).bullet.buildingDamageMultiplier = 0.01;
...
UnitTypes.arkyid.weapons.get(2).bullet.buildingDamageMultiplier = 0.01;
...
Blocks.salvo.ammoTypes.get(Items.graphite).ammoMultiplier = 3;
...
Blocks.salvo.ammoTypes.get(Items.silicon).ammoMultiplier = 3;
...
Blocks.salvo.ammoTypes.get(Items.pyratite).ammoMultiplier = 6;
...
Blocks.ripple.ammoTypes.get(Items.silicon).ammoMultiplier = 2;
